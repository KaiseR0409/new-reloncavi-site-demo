...
export default function Servicios() {
  return (
    <div>
      ...
      <section className="relative bg-cover bg-center bg-fixed py-16 px-6" style={{ backgroundImage: "url(/img/negocios/DJI_0072.webp)" }}>
